...
export function TopWhales({ transactions, ethPrice }: Props) {
  // Deduplicate by address — keep the largest tx per address
      ...
      {top10.length === 0 ? (
        ...
        <div>
          {top10.map((tx, i) => {
            ...
            return (
              <div key={tx.from} className="whale-rank-item">
